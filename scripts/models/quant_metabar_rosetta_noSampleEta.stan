data { // 
  ...
  int N_obs_samp_small;  // Number of observed samples for individual stations.
 ...
 //vector[N_obs_mock_small]  model_vector_a_mock_small;
  ...
  // int up_idx[N_obs_samp_small/2]; //index of upstream stations
  // int down_idx[N_obs_samp_small/2]; //index of downstream stations
