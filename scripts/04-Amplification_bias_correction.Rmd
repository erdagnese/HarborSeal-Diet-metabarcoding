...
saveRDS(int_samp_small_tibble, here("intermediate-files","CorrectionBiasRun","Prey18S","20250829_bayesout_ControlFeedingTMWildScats_int_samp_small_tibble.RDS"))
...
saveRDS(plotting_data, here("intermediate-files","CorrectionBiasRun","Prey18S", "20250829_bayesout_ControlFeedingTMWildScats_qm_data_plotting.rds"))
...
saveRDS(mean_estimates, here("intermediate-files","CorrectionBiasRun","Prey18S", "20250829_bayesout_ControlFeedingTMWildScats_qm_mean_estimates.rds"))
saveRDS(summary_stats, here("intermediate-files","CorrectionBiasRun","Prey18S", "20250829_bayesout_ControlFeedingTMWildScats_qm_samp_small_summary_stats.rds"))
saveRDS(species_summary, here("intermediate-files","CorrectionBiasRun","Prey18S", "20250829_bayesout_ControlFeedingTMWildScats_qm_species_summary.rds"))
saveRDS(full_posterior, here("intermediate-files","CorrectionBiasRun","Prey18S", "20250829_bayesout_ControlFeedingTMWildScats_full_posterior.rds"))
