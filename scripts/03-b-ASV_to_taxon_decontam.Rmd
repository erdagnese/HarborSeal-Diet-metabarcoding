...
# for mifish
tax <- read_tsv(here("intermediate-files","CorrectionBiasRun","MiFish","MiFish_final_Taxonomy.tsv"))
...
posCtrlasv <- posctrl_decontam_data(asv, c("Plate3_H12","PosCtrl_Kangaroo_MF4"))
...
write.csv(taxon_table_wide, file = here::here("intermediate-files", "CorBias_MiFish_taxon_decontam_asv_table.csv") , row.names = F)
